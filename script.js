function carregaDicionario() {
    var biografias = {
        ...
        for(var bio in biografias) {
            ...
            <img src="${biografias[bio].imagem}" width="150" alt="">

            <details>

                <summary>${biografias[bio].nome}</summary>

                <p><strong>${biografias[bio].descricao}</strong></p>

                <blockquote><q><strong>Citação: ${biografias[bio].citacao}</strong></q></blockquote>
